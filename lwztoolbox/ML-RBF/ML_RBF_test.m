function [HammingLoss,RankingLoss,OneError,Coverage,Average_Precision,Outputs,Pre_Labels,te_time]=ML_RBF_test(test_data,test_target,Centroids,Sigma_value,Weights)
